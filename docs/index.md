# go-ruby-mysql documentation

**Pure-Go (CGO=0) reimplementation of Ruby's mysql2 gem, over go-sql-driver/mysql**

`go-ruby-mysql/mysql` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `mysql`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `mysql`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`mysql`](https://github.com/go-ruby-mysql/mysql) | the library — Ruby's `mysql` in pure Go |
| [`docs`](https://github.com/go-ruby-mysql/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-mysql.github.io`](https://github.com/go-ruby-mysql/go-ruby-mysql.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-mysql/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-mysql/mysql](https://github.com/go-ruby-mysql/mysql).
