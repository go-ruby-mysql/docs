...
The public API lives at the module root (`github.com/go-ruby-mysql/mysql`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `mysql`, while the surface follows
...
```go
import "github.com/go-ruby-mysql/mysql"
```
...
- **[pkg.go.dev/github.com/go-ruby-mysql/mysql](https://pkg.go.dev/github.com/go-ruby-mysql/mysql)**

The module's [README](https://github.com/go-ruby-mysql/mysql#readme) carries worked
