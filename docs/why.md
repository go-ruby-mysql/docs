...
`go-ruby-mysql/mysql` reimplements Ruby's `mysql` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-mysql/mysql` directly, with no Ruby runtime;
